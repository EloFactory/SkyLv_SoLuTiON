namespace SkyLv_Evelynn
{
    ...
    internal class PotionManager
    {
        ...
        {
            //Menu
            SkyLv_Evelynn.Menu.SubMenu("Misc").AddItem(new MenuItem("Evelynn.AutoPotion", "Use Auto Potion").SetValue(true));
        ...
        public static void PotionManagerFunction()
        {
            ...
            if (SkyLv_Evelynn.Menu.Item("Evelynn.AutoPotion").GetValue<bool>() && !Player.InFountain() && !Player.IsRecalling() && !Player.IsDead)
            {
