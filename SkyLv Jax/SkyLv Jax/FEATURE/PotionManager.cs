namespace SkyLv_Jax
{
    ...
    internal class PotionManager
    {
        ...
        {
            //Menu
            SkyLv_Jax.Menu.SubMenu("Misc").AddItem(new MenuItem("Jax.AutoPotion", "Use Auto Potion").SetValue(true));
        ...
        public static void PotionManagerFunction()
        {
            ...
            if (SkyLv_Jax.Menu.Item("Jax.AutoPotion").GetValue<bool>() && !Player.InFountain() && !Player.IsRecalling() && !Player.IsDead)
            {
