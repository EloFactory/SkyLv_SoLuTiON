namespace SkyLv_Jax
{
    ...
    internal class KillSteal
    {
        ...
        public static void KS()
        {
            ...
            foreach (var target in ObjectManager.Get<Obj_AI_Hero>().Where(target => !target.IsMe && !target.IsDead && target.Team != ObjectManager.Player.Team && !target.IsZombie && (SkyLv_Jax.Ignite.Slot != SpellSlot.Unknown || !target.HasBuff("summonerdot"))))
            {
