namespace SkyLv_Jax
{
    ...
    internal class JungleClear
    {
        ...
        {
            //Menu
            SkyLv_Jax.Menu.SubMenu("JungleClear").AddItem(new MenuItem("Jax.UseQJungleClear", "Use Q In JungleClear").SetValue(true));
            SkyLv_Jax.Menu.SubMenu("JungleClear").AddItem(new MenuItem("Jax.QMiniManaJungleClear", "Minimum Mana To Use Q In JungleClear").SetValue(new Slider(0, 0, 100)));
            SkyLv_Jax.Menu.SubMenu("JungleClear").AddItem(new MenuItem("Jax.UseWJungleClear", "Use W In JungleClear").SetValue(true));
            SkyLv_Jax.Menu.SubMenu("JungleClear").AddItem(new MenuItem("Jax.WMiniManaJungleClear", "Minimum Mana To Use W In JungleClear").SetValue(new Slider(0, 0, 100)));
            SkyLv_Jax.Menu.SubMenu("JungleClear").AddItem(new MenuItem("Jax.UseEJungleClear", "Use E In JungleClear").SetValue(true));
            SkyLv_Jax.Menu.SubMenu("JungleClear").AddItem(new MenuItem("Jax.EMiniManaJungleClear", "Minimum Mana To Use E In JungleClear").SetValue(new Slider(0, 0, 100)));
            SkyLv_Jax.Menu.SubMenu("JungleClear").AddItem(new MenuItem("Jax.UsePacketCastJungleClear", "Use PacketCast In JungleClear").SetValue(false));
        ...
        {
            var PacketCast = SkyLv_Jax.Menu.Item("Jax.UsePacketCastJungleClear").GetValue<bool>();
