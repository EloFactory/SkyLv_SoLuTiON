namespace SkyLv_Tristana
{
    ...
    internal class PotionManager
    {
        ...
        {
            //Menu
            SkyLv_Tristana.Menu.SubMenu("Misc").AddItem(new MenuItem("Tristana.AutoPotion", "Use Auto Potion").SetValue(true));
        ...
        public static void PotionManagerFunction()
        {
            ...
            if (SkyLv_Tristana.Menu.Item("Tristana.AutoPotion").GetValue<bool>() && !Player.InFountain() && !Player.IsRecalling() && !Player.IsDead)
            {
