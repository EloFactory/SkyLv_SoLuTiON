namespace SkyLv_Taric
{
    ...
    internal class OnUpdateFeatures
    {
        ...
        public static void AutoQAlly()
        {
            ...
            if (SkyLv_Taric.Menu.Item("Taric.UseQAllyMode").GetValue<StringList>().SelectedIndex == 1 && Q.IsReady() && Player.Mana >= Q.ManaCost)
            {
        ...
        public static void AutoWAlly()
        {
            ...
            if (SkyLv_Taric.Menu.Item("Taric.UseWAllyMode").GetValue<StringList>().SelectedIndex == 1 && W.IsReady() && Player.Mana >= W.ManaCost)
            {
